...
## Usage instructions
#### 1. Usages of TCRsep in Python script
1.1 Utilities of TCRsep module using a default selection model:
```python
...
```
1.2 Sharing analysis by TCRsep:
```python
...
```
#### 3. Train a TCRsep model using the command-line: 
...
#### 4. Use the TCRsep to infer selection factors, pre- and post-selection probabilities:
